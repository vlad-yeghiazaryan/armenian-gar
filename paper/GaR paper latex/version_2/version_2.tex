...
% Title
\title{Measuring the risk build-up in Armenian financial system: A Growth-at-Risk approach\thanks{This paper is the sole responsibility of its authors. The views expressed in this paper are ours and do not necessarily reflect the views of the Central Bank of Armenia.}}

\author{
Vladimir Yeghiazaryan\thanks{Central Bank of Armenia, Yerevan, Armenia. Email: \texttt{vladimir.yeghizaryan@cba.am}}
\and 
Arthur Grigoryan\thanks{Central Bank of Armenia, Yerevan, Armenia. Email: \texttt{arthur.grigoryan@cba.am}}
}
...
\begin{abstract}
    ...
    We contribute to the existing literature by two main ways 1. we estimate the long-term sustainable level of systemic risks relative to the resilience of the financial system using estimates of a panel model with 41 countries, 2. we offer improvements to existing macroprudential policy rule frameworks in the current literature to augment the decision-making process. Lastly, we check whether the outputs of well known papers in this field hold in a small open economy like Armenia.
\end{abstract}
...
Building on the insights from the literature, we employ both panel and localized quantile regressions. We focus on key risk indicators such as accumulated financial vulnerability and financial stress, supplemented by structural variables like the capital adequacy ratio (CAR) and the liquidity ratio (HQLA/Assets). The latters are included to take into account also the lending capacity of banks: the less the capital surplus of a bank, the more impact should macroprudential policy tightening have on its credit supply. Since Armenia is a small open economy, we also incorporate a general indicator for macroeconomy (MI) to account for the impact of external shocks. After estimating conditional quantiles, we interpolate between them using both parametric and non-parametric methods. Finally, for deriving the macroprudential stance we use the distance-to-tail metric \citep{esrb2024}, but also extend that with the work of \citet{suarez2022}.
...
\begin{figure}[!ht]
    \centering 
    \includegraphics[width=0.9\textwidth, angle=0]{../Figures/arm_MPI_actions.png}    
...
We extend our gratitude to Ashot Nanyan and Ashot Sargsyan, both from the Financial Stability Directorate, Central Bank of Armenia (CBA), for their valuable suggestions and constructive discussions. We also thank our colleagues, Gevorg Minasyan and Aleksandr Shirkhanyan from the Economic Research Department at the CBA for their insightful comments. Special thanks to Vladimir Asriyan for his feedback and ideas on enhancing the Growth-at-Risk framework.
