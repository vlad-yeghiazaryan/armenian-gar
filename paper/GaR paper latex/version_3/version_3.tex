...
% Title
\title{Measuring the systemic risk build-up and macroprudential policy impact in Armenian financial system: A Growth-at-Risk approach\thanks{This paper is the sole responsibility of its authors. The views expressed in this paper are ours and do not necessarily reflect the views of the Central Bank of Armenia.}}
...
We extend our gratitude to Ashot Nanyan and Ashot Sargsyan, both from the Financial Stability Directorate, Central Bank of Armenia (CBA), for their valuable suggestions and constructive discussions. We also thank our colleagues, Tatul Hayruni, Gevorg Minasyan and Aleksandr Shirkhanyan from the Economic Research Department at the CBA for their insightful comments. Special thanks to Vladimir Asriyan for his feedback and ideas on enhancing the Growth-at-Risk framework.
