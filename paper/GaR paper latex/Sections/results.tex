...
Macroprudential policy enters the panel and local equations through both direct and indirect (interaction) effects. Direct effects capture the benefits of increased resilience from policy interventions, as well as the associated costs. Interaction effects, on the other hand, capture the role of macroprudential policy in mitigating systemic risks.
...
To examine the overall impact of macroprudential policy, we present the conditional MPI coefficients in \autoref{fig:arm_MPI_cond_coeff_quantiles}. Both short- and long-term effects highlight the positive influence on the lower tail of the GDP growth distribution and the negative impact on the upper quantiles. The findings suggest that macroprudential policy is most effective during periods of low financial stress. However, if such periods coincide with excessive credit growth or asset price surges, the short-term costs to growth will be higher. Nonetheless, these conditions also lead to the most significant reduction of risks in the medium term.