function contrplot7(FCI, C, Date )
...
bar(datenum(Date),C(:,8),'FaceColor',[0.7 0.7 0.7],'EdgeColor',[0.7 0.7 0.7],'LineWidth',2); hold on
plot(datenum(Date),FCI,'k','LineWidth',3); hold off
datetick('x','yyyy');
xlim([min(datenum(Date)) max(datenum(Date))]);
legend({'7', '6', '5', '4', '3', '2', '1', 'Contr. of Corr', 'FCI'}, 'Location','South', 'Orientation', 'horizontal' );
